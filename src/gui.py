...
def app():
    ...
    # Tlačítko start/stop
    tlacitko = Button(frame, text ="Start", command = zaciname, width=12, height=3, bg="darkturquoise", font=("Ariel, 12"))
    ...
    quit_button = Button(frame, text='Zavřít', command=quit, width=12, height=3, bg='darkturquoise', font=("Ariel, 12"))
    quit_button.grid(row=2, column=2, pady=(0,30))
